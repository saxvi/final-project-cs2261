...
# 1 "startBG2.h" 1
# 22 "startBG2.h"
extern const unsigned short startBG2Tiles[1456];
...
# 24 "main.c" 2
# 1 "pigeonPhotoGAMEVER.h" 1
# 22 "pigeonPhotoGAMEVER.h"
extern const unsigned short pigeonPhotoGAMEVERTiles[13920];


extern const unsigned short pigeonPhotoGAMEVERMap[1024];


extern const unsigned short pigeonPhotoGAMEVERPal[256];
# 25 "main.c" 2
# 1 "loseScreen.h" 1
# 22 "loseScreen.h"
...
void goToStart() {
    ...
    (*(volatile unsigned short*)0x4000008) = ((1) << 2) | ((26) << 8) | (1 << 14) | (1 << 7);

    hOff = 0;


    DMANow(3, startXLPal, ((unsigned short *)0x5000000), 256);
    ...
    DMANow(3, startBG2Tiles, &((charblock *)0x06000000)[0], 2912 / 2);
...
void goToWin() {
    ...
    DMANow(3, pigeonPhotoGAMEVERTiles, &((charblock *)0x06000000)[0], 27840/2);
    DMANow(3, pigeonPhotoGAMEVERMap, &((screenblock *)0x6000000)[31], 2048/2);
